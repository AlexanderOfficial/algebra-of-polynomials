...
В рамках лабораторной работы ставится задача создания программных средств, поддерживающих реализацию шести видов таблиц, предназначенных эффектривного для хранения полинома, его имени и ссылки на объект класса Polinom:
...
В рамках лабораторной работы также разработать выполнение следующих операций над полиномами:
...
Также должна быть реализована возможность получения выражения из полиномов.
